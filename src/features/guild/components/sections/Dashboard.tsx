            ...
            <div className="flex flex-col min-h-screen bg-transparent text-default w-full justify-center items-center gap-8 p-4">
                <div className="w-full max-w-6xl flex flex-col justify-center items-center gap-8">
                    ...
                    <div className="text-center">
                        <h1 className="text-3xl md:text-4xl font-extralight mb-2">Guild Dashboard</h1>
                        <p className="text-lg font-light opacity-80">Test Server Analytics</p>
                    </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="text-sm opacity-70">Online Now</div>
                                    </div>
                                    <div className="text-center">
                                        <div className="text-3xl font-bold text-purple-400">23</div>
                                        <div className="text-sm opacity-70">Active Events</div>
                                    </div>
                                    <div className="text-center">
                                ...
                                <div className="p-6 space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="bg-black/20 rounded-lg p-3 border border-white/10">
                                            <div className="text-sm font-medium">🎮 Game Night</div>
                                            <div className="text-xs opacity-60">Tomorrow at 8:00 PM</div>
                                            <div className="text-xs opacity-60">23 attendees</div>
                                        </div>
                                    </div>
                                    <NxtBtn
                        ...
                        <div className="hover:scale-105 transition-transform duration-300 cursor-pointer">
                            <GlassBox>
                                <div className="p-6 space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-sm opacity-70">Organize parties and group activities</p>
                                        <div className="text-xs opacity-60">
                                            <div>Parties this month: <span className="font-semibold">12</span></div>
                                            <div>Avg attendance: <span className="font-semibold">18 people</span></div>
                                        </div>
                                    </div>
                                    <NxtBtn
